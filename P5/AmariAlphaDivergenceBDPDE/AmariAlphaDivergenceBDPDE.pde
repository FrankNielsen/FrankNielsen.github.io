...
void test()
{
  println("Test the identity of alpha-divergences as representational Bregman divergences");
  ...
  println("extended alpha divergence:\t\t\t\t"+alphadiv);

  bd=BD(alpha, k1, k2);
  println("Bregman divergence on primal krep:\t\t\t"+bd);

  yf=YF(alpha, k1, k2star);
  println("Fenchel-Young divergence on dual krepresentations:\t"+yf);
}
