...
%\begin{tabular}{llll}
%Information & definition & mean & divergence \\
 %$(M,D)$-information     & $I_{M,D}[p,q]=\min_c \{M(D[p:c],D[q:c])\}$ & $M$ & $D$\\  \hline\hline
%Information radius of order $1$ & $I_{A,\KL}[p,q]=\frac{1}{2}D_\KL[p:\frac{p+q}{2}]+\frac{1}{2}D_\KL[q:\frac{p+q}{2}]$ &  $A(a,b)=\frac{a+b}{2}$ & $D$\\
%aka Jensen-Shannon divergence & \\
%Information radius of order $\alpha$ & $I_{M_\alpha^R,D_{\alpha}^R}[p,q]=\frac{\alpha}{\alpha-1}\log_2 \int_\calX \left(\frac{ p(x)^\alpha+ q(x)^\alpha}{2}\right)^{\frac{1}{\alpha}} \dmu(x)$ & $M_\alpha^R(a,b)=\frac{1}{\alpha-1}\log_2\left(\frac{2^{(\alpha-1)a}+2^{(\alpha-1)b}}{2}\right)$ & $D_\alpha^R[p:q]=\frac{1}{\alpha-1}\log_2\left( \int_\calX p(x)^\alpha q(x)^{1-\alpha}\dmu(x)\right)$\\
%aka Sibson's information radius & & R\'enyi $\alpha$-mean & R\'enyi $\alpha$-divergence\\ 
%\end{tabular}
